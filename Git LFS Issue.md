...
```zsh
(netflix-analysis) paul@Pauls-MBP netflix-analysis % git pull
...
hint: invocation.
Already up to date.
(netflix-analysis) paul@Pauls-MBP netflix-analysis % git push
Enumerating objects: 20, done.
Counting objects: 100% (20/20), done.
Delta compression using up to 4 threads
Compressing objects: 100% (15/15), done.
Writing objects: 100% (15/15), 76.22 MiB | 6.79 MiB/s, done.
Total 15 (delta 8), reused 0 (delta 0), pack-reused 0
remote: Resolving deltas: 100% (8/8), completed with 3 local objects.
remote: error: Trace: e7486ef67775eea1b6a720037b7c2743e87b94e3489cde02d8364bc1f7be05bb
remote: error: See http://git.io/iEPt8g for more information.
remote: error: File data/rotten_tomatoes_critic_reviews.csv is 215.58 MB; this exceeds GitHub's file size limit of 100.00 MB
remote: error: GH001: Large files detected. You may want to try Git Large File Storage - https://git-lfs.github.com.
To https://github.com/PKilgarriff/netflix-analysis.git
 ! [remote rejected] main -> main (pre-receive hook declined)
error: failed to push some refs to 'https://github.com/PKilgarriff/netflix-analysis.git'
(netflix-analysis) paul@Pauls-MBP netflix-analysis % git lfs migrate
...
* --everything:
    ...
    git  pack-refs). On "case-insensitive" file systems, e.g. NTFS on Windows
    or default APFS on macOS, git lfs migrate would only migrate the first
...
```zsh
paul@Pauls-MBP netflix-analysis % git lfs migrate info
migrate: Fetching remote refs: ..., done.
migrate: Sorting commits: ..., done.
migrate: Examining commits: 100% (3/3), done.
*.csv           247 MB  3/3 files       100%
*.ipynb         1.5 MB  6/6 files       100%
*.lock          104 KB  2/2 files       100%
Pipfile         387 B   2/2 files       100%
*.gitignore     24 B    1/1 file        100%
paul@Pauls-MBP netflix-analysis % git lfs migrate import --include="*.csv"
migrate: Fetching remote refs: ..., done.
migrate: Sorting commits: ..., done.
migrate: Rewriting commits: 100% (3/3), done.
  main  95087ffa448231a07fa3f092ed01edea4ff7a793 -> bc9e0b0b1b4d1baad568f1aa1e16372c6f7cc665
migrate: Updating refs: ..., done.
migrate: checkout: ..., done.
paul@Pauls-MBP netflix-analysis % git push -f
Uploading LFS objects: 100% (3/3), 247 MB | 2.2 MB/s, done.
Enumerating objects: 23, done.
Counting objects: 100% (23/23), done.
Delta compression using up to 4 threads
Compressing objects: 100% (16/16), done.
Writing objects: 100% (17/17), 13.65 KiB | 2.27 MiB/s, done.
Total 17 (delta 8), reused 0 (delta 0), pack-reused 0
remote: Resolving deltas: 100% (8/8), completed with 3 local objects.
To https://github.com/PKilgarriff/netflix-analysis.git
   f928422..bc9e0b0  main -> main
paul@Pauls-MBP netflix-analysis % git lfs export
Error: unknown command "export" for "git-lfs"
Run 'git-lfs --help' for usage.
paul@Pauls-MBP netflix-analysis % git lfs migrate export
One or more files must be specified with --include
paul@Pauls-MBP netflix-analysis % git lfs migrate export --include="*.csv"
migrate: Fetching remote refs: ..., done.
migrate: Sorting commits: ..., done.
migrate: Rewriting commits: 100% (0/0), done.
migrate: Updating refs: ..., done.
migrate: checkout: ..., done.
prune: 3 local objects, 3 retained, done.
paul@Pauls-MBP netflix-analysis % git lfs checkout
Checking out LFS objects: 100% (3/3), 247 MB | 0 B/s, done.
paul@Pauls-MBP netflix-analysis % git lfs migrate export --include="*.csv"
migrate: Fetching remote refs: ..., done.
migrate: Sorting commits: ..., done.
migrate: Rewriting commits: 100% (0/0), done.
...
paul@Pauls-MBP netflix-analysis % git lfs info
...
migrate: Sorting commits: ..., done.
migrate: Examining commits: 100% (0/0), done.
paul@Pauls-MBP netflix-analysis % pipenv shell
Launching subshell in virtual environment...
 . /Users/paul/.local/share/virtualenvs/netflix-analysis-BB5axs-S/bin/activate
paul@Pauls-MBP netflix-analysis %  . /Users/paul/.local/share/virtualenvs/netflix-analysis-BB5axs
-S/bin/activate
(netflix-analysis) paul@Pauls-MBP netflix-analysis % git lfs migrate export --include="*.csv"
migrate: Fetching remote refs: ..., done.
migrate: Sorting commits: ..., done.
migrate: Rewriting commits: 100% (0/0), done.
migrate: Updating refs: ..., done.
migrate: checkout: ..., done.
prune: 3 local objects, 3 retained, done.
(netflix-analysis) paul@Pauls-MBP netflix-analysis % git lfs migrate import --include="*.csv"
migrate: Fetching remote refs: ..., done.
migrate: Sorting commits: ..., done.
migrate: Rewriting commits: 100% (0/0), done.
migrate: Updating refs: ..., done.
...
To https://github.com/PKilgarriff/netflix-analysis.git
   bc9e0b0..60c1316  main -> main
(netflix-analysis) paul@Pauls-MBP netflix-analysis % git push
Uploading LFS objects: 100% (1/1), 3.4 MB | 390 KB/s, done.
...
remote: Resolving deltas: 100% (2/2), completed with 2 local objects.
To https://github.com/PKilgarriff/netflix-analysis.git
   60c1316..b30c6be  main -> main
(netflix-analysis) paul@Pauls-MBP netflix-analysis %
```
